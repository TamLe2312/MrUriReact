...
import "./chunk-NZWTZ2KQ.js";
import "./chunk-P7LQF6WC.js";
import {
  useSlotProps
...
function ChartsVoronoiHandler(props) {
  ...
  React28.useEffect(() => {
    ...
    function getClosestPoint(event) {
      ...
      const closestPointIndex = (_a = voronoiRef.current.delauney) == null ? void 0 : _a.find(svgPoint.x, svgPoint.y);
      ...
      if (voronoiMaxRadius !== void 0) {
        const pointX2 = voronoiRef.current.delauney.points[2 * closestPointIndex];
        const pointY2 = voronoiRef.current.delauney.points[2 * closestPointIndex + 1];
